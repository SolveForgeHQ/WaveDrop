// Centralised icon components used across the app
...
export function GiftIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <path d="M21 8H3V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v2zM12 8v14M12 8c0-2.5-2-4-2-4s2 0 2 4zM12 8c0-2.5 2-4 2-4s-2 0-2 4z"/>
    </svg>
  );
}
